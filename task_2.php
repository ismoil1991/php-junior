            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                        ...
                        <?php
                        $array = [
                            'Privacy' => 'Your privacy is important to us at SmartAdmin and the protection, confidentiality and
                            ...
                            'Cookies and other similar technologies' => 'We collect certain data through cookies and similar technologies (e.g. web beacons, tags,
                        ...
                        foreach ($array as $key => $item) {
                            echo $key == 'Privacy' ? '<h2>'. $key . '</h2>' : '<h3>' . $key . '</h3>';
                            echo $key == 'Privacy' ? '<p class="mb-g">' . $item . '</p>' : '<p>' . $item . '</p>';
                        }
                        ?>
                    </div>
                </div>
