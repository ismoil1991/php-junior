                    ...
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        <?php foreach ($people as $person):?>
                            <div class="<?php echo $person['status'] == 'banned' ? 'banned ' : ''?>rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?= $person['img'];?>" alt="<?= $person['img_alt'];?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                        <?= $person['name'];?>
                                    ...
                                    <a href="<?= $person['email_link_href'];?>" class="text-info fs-sm" target="_blank" title="<?= $person['title'];?>"><?= $person['email_link_text'];?></a>
                                </div>
                            </div>
                        <?php endforeach;?>
                    </div>
