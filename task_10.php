...
//    $data = $_POST['text'];
//
//    $select = "SELECT text FROM others WHERE text='{$data}'";
//    $obj = mysqli_query($connection, $select);
//    $res = mysqli_fetch_all($obj);
//
//    if ($res[0][0] == $data) {
//        $error = "You should check in on some of those fields below.";
//    } else {
//        $insert = "INSERT INTO others (text) VALUES ('{$data}')";
...
//                            } elseif ($success) {
//                                echo '<div class="alert alert-success fade show" role="alert">' . $success . '</div>';
//                            }
//                            ?>
